...
class AnalyticsTracker {
    constructor() {
        this.storageKey = 'jca_campaign_analytics';
        this.sessionKey = 'jca_session_id';
        this.init();
    }
    ...
    displayWelcome() {
        const styles = {
            header: 'color: #10b981; font-size: 24px; font-weight: bold; text-shadow: 2px 2px 4px rgba(0,0,0,0.2);',
            info: 'color: #8b5cf6; font-size: 14px;',
            command: 'background: #10b981; color: white; padding: 4px 8px; border-radius: 4px; font-weight: bold;'
        };
...
window.verEstadisticas = function() {
    ...
    console.group('%c📈 Métricas Generales', 'color: #8b5cf6; font-weight: bold;');
    ...
    console.group('%c🌐 Clicks por Plataforma', 'color: #8b5cf6; font-weight: bold;');
    ...
    if (stats.recentClicks.length > 0) {
        console.group('%c⏱️ Clicks Recientes', 'color: #8b5cf6; font-weight: bold;');
...
class ParticleSystem {
    constructor() {
        ...
        this.colors = ['#10b981', '#8b5cf6', '#ffffff'];
    }
...
function activateEasterEgg() {
    console.log('%c🎉 ¡EASTER EGG ACTIVADO!', 
        'color: #10b981; font-size: 24px; font-weight: bold; animation: rainbow 2s linear infinite;');
